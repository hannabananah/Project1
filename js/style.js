$(function() {
    ...
    var sec2_dots_ac = $('#section2 .travel-slider-box .slick-dots li.slick-active'),
        ...
        sec2_slide_a = $('#section2 .travel-slider-box .travel-slider .slick-slide ul li a'),
        sec2_slide_a01 = $('#section2 .travel-slider-box .travel-slider .slick-slide:nth-child(1) ul li a'),
        sec2_slide_a02 = $('#section2 .travel-slider-box .travel-slider .slick-slide:nth-child(2) ul li a'),
        sec2_slide_a03 = $('#section2 .travel-slider-box .travel-slider .slick-slide:nth-child(3) ul li a'),
        map_action = $('#section2 .map_action div');

    sec2_slide.css({ width: '747px', position: 'relative', left: '0px', top: '0px', 'z-index': '998', opacity: '0' });
    ...
    sec2_slide.each(function() {
        ...
        sec2_slide_a01.eq(0).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/01.png)' });
        });
        sec2_slide_a01.eq(1).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/02.png)' });
        });
        sec2_slide_a01.eq(2).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/03.png)' });
        });
        sec2_slide_a01.eq(3).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/04.png)' });
        });
        sec2_slide_a01.eq(4).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/05.png)' });
        });
        sec2_slide_a01.eq(5).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/06.png)' });
        });
        sec2_slide_a01.eq(6).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/07.png)' });
        });
        sec2_slide_a01.eq(7).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/08.png)' });
        });
        sec2_slide_a01.eq(8).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/09.png)' });
        });
        sec2_slide_a01.eq(9).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/10.png)' });
        });
        sec2_slide_a01.eq(10).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/11.png)' });
        });
        sec2_slide_a01.eq(11).mouseover(function() {
            sec2_slide_tb01.css({ 'background-image': 'url(../images/thumb/01/12.png)' });
        });

        /* slide02 */
        sec2_slide_a02.eq(0).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/01.png)' });
        });
        sec2_slide_a02.eq(1).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/02.png)' });
        });
        sec2_slide_a02.eq(2).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/03.png)' });
        });
        sec2_slide_a02.eq(3).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/04.png)' });
        });
        sec2_slide_a02.eq(4).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/05.png)' });
        });
        sec2_slide_a02.eq(5).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/06.png)' });
        });
        sec2_slide_a02.eq(6).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/07.png)' });
        });
        sec2_slide_a02.eq(7).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/08.png)' });
        });
        sec2_slide_a02.eq(8).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/09.png)' });
        });
        sec2_slide_a02.eq(9).mouseover(function() {
            sec2_slide_tb02.css({ 'background-image': 'url(../images/thumb/02/10.png)' });
        });

        /* slide03 */
        sec2_slide_a03.eq(0).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/01.png)' });
        });
        sec2_slide_a03.eq(1).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/02.png)' });
        });
        sec2_slide_a03.eq(2).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/03.png)' });
        });
        sec2_slide_a03.eq(3).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/04.png)' });
        });
        sec2_slide_a03.eq(4).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/05.png)' });
        });
        sec2_slide_a03.eq(5).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/06.png)' });
        });
        sec2_slide_a03.eq(6).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/07.png)' });
        });
        sec2_slide_a03.eq(7).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/08.png)' });
        });
        sec2_slide_a03.eq(8).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/09.png)' });
        });
        sec2_slide_a03.eq(9).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/10.png)' });
        });
        sec2_slide_a03.eq(10).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/11.png)' });
        });
        sec2_slide_a03.eq(11).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/12.png)' });
        });
        sec2_slide_a03.eq(12).mouseover(function() {
            sec2_slide_tb03.css({ 'background-image': 'url(../images/thumb/03/13.png)' });
        });
    });
